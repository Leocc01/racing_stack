...
#
# Stage 2 sources the thirdimpact ROS env automatically; if ROS isn't available it is
...
if [ "$DO_EKF" = 1 ]; then
  echo "==> [2/3] robot_localization replay (real ekf_node; sources thirdimpact ROS env)"
